...
public class LoginController implements Initializable {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    pass.textProperty().bindBidirectional(passwordTextField.textProperty());
    ...
    try {
      if (username.getText().trim().isEmpty() || pass.getText().trim().isEmpty()) {
        ...
        if (!Objects.isNull(usu)) {
          ...
          dialogStage.setTitle("Control de Horarios");
          dialogStage.getIcons()
              .add(new Image(getClass().getResourceAsStream("/resources/images/palobiofarma.png")));
